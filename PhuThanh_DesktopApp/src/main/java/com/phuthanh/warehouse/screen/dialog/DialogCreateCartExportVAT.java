...
public class DialogCreateCartExportVAT {
    ...
    private void onSave() {
        try {
            ...
            List<Object> valuesRequest = Arrays.asList(
                    ...
                    priceVAT, paymentID, billID, sourceID, deliveryID, employeeID, false, txtDeliveryTime.getValue(),
            ...
            if (isEditMode.equals("UPDATE")) {
                ...
                customDialogNotification.showDialog("Thành công", "Thêm phiếu thành công",
                        Alert.AlertType.INFORMATION);
            }
